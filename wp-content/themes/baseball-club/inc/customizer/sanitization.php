 ...
 */
function baseballclub_sanitize_checkbox( $checked ) {
	// Boolean check.
...
function baseballclub_switch_sanitization( $input ) {
    if ( true === $input ) {
        return 1;
    } else {
        return 0;
...
function baseballclub_sanitize_choices( $input, $setting ) {
    global $wp_customize; 
...
function baseballclub_sanitize_float( $input ) {
 ...
 */
function baseballclub_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function baseballclub_sanitize_html( $html ) {
 ...
 */
function baseballclub_sanitize_image( $image, $setting ) {
 ...
 */
function baseballclub_sanitize_nohtml( $nohtml ) {
 ...
 */
function baseballclub_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function baseballclub_sanitize_range_value( $number, $setting ) {
 ...
 */
function baseballclub_sanitize_select( $input, $setting ) {
 ...
 */
function baseballclub_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function baseballclub_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function baseballclub_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}
