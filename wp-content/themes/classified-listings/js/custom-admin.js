...
async function run () {
  const observer = new MutationObserver((mutations) => {
    mutations.forEach((mutation) => {
      var modal_btn_svg_icon = ` <button class="btn btn-success" onclick="window.open('https://www.vwthemes.com/themes/classified-wordpress-theme/','_blank')">BUY NOW</button>`;
