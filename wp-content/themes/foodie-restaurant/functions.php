...
//redirect
Function foodie_restaurant_notice(){
    global $pagenow;
    if ( is_admin() && ('themes.php' == $pagenow) && isset( $_GET['activated'] ) ) {
   		wp_safe_redirect( admin_url("themes.php?page=foodie-restaurant-guide-page") );
   	}
}
add_action('after_setup_theme', 'foodie_restaurant_notice');
