    ...
    <div class="col-lg-3 col-md-3 col-sm-3 slider-info p-0">
      <div class="contact-info">
        <?php if ( get_theme_mod('foodie_restaurant_header_phone_number') ) : ?>
          <p><i class="fas fa-phone mr-2"></i><?php esc_html_e('Call - ','foodie-restaurant'); ?><a href="callto:<?php echo esc_html(get_theme_mod('foodie_restaurant_header_phone_number','')); ?>"><?php echo esc_html(get_theme_mod('foodie_restaurant_header_phone_number','')); ?></a></p>
        <?php endif; ?>
        <?php if ( get_theme_mod('foodie_restaurant_header_email') ) : ?>
          <p><i class="fas fa-paper-plane mr-2"></i><?php esc_html_e('Mail Us - ','foodie-restaurant'); ?><a href="mailto:<?php echo esc_html(get_theme_mod('foodie_restaurant_header_email','')); ?>"><?php echo esc_html(get_theme_mod('foodie_restaurant_header_email','')); ?></a></p>
        <?php endif; ?>
